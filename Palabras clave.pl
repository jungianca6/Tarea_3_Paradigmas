...
dieta(ketovegana_diabetes_activa, diabetes, 2130, 3000, 3, 6, [vegana, keto], [dulce], [
    desayuno('1 batido verde con espinacas, manzana y semillas de chÃ­a.', '1 rebanada de pan integral con aguacate.'),
...
% Regla para encontrar la dieta adecuada segÃºn los parÃ¡metros
